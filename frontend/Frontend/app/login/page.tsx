      ...
      <div className="min-h-screen flex items-center justify-center bg-background">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to place orders and track your dining experience</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-muted rounded-lg">
              <h3 className="font-semibold mb-2 text-sm">New Customer?</h3>
              <p className="text-xs text-muted-foreground mb-2">
                You can browse our menu and place orders without an account, but logging in allows you to:
              </p>
